<?php
  ...
  include "php/select_without_auction.php"; 
  $wo_auction = $data;
  unset($data);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>A-Mart Smart Shopping-View without Auction product</title>
    <!--favicon-->
    <!-- responsive -->
      ...
      <div class="content-wrapper">
        <div class="container-fluid">
          ...
          <div class="row pt-2 pb-2">
            <div class="col-sm-9">
              <h4 class="page-title">Without Auction Product</h4>
            </div>
          </div>
          <!-- End Breadcrumb-->
          <div class="row">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="padding: 0px;"> 
                            ...
                            <button type="button" class="btn btn-dark waves-effect waves-light m-1"><i class="fa fa-times" aria-hidden="true"></i> <span>Deactive</span> </button>
                            <?php } else { ?>
                            <a href="php/changestatus_product?id=<?php echo $value['P_id']?>">
                            ...
                            <a href="php/delete_without_auction?id=<?php echo $value['P_id'] ?>" >
