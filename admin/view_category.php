              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap display responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $value['Cat_created'] ?></td>
                          <td><?php echo $value['Cat_updated'] ?></td>
                          <td style="padding: 0px;"> 
                            <!-- status -->
                            <?php if($value['Cat_status'] == 0) { ?>
                              <a href="php/changestatus_category?id=<?php echo $value['Cat_id']?>">
                            ...
                            <?php } ?></a>
                            <!-- edit -->
                            <button type="button" class="btn btn-success waves-effect waves-light m-1" data-toggle="modal" data-target="#a<?php echo $value['Cat_id'] ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <span>Edit</span> </button>
                            <a href="php/cat_delete?id=<?php echo $value['Cat_id'] ?>">
                    ...
                    <?php foreach ($view_cat as $row) {
                      ?>
                    <!-- The Modal -->
                    <div class="modal fade" id="a<?php echo $row['Cat_id'] ?>">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <form id="signupForm" action="php/cat_update?id=<?php echo($row['Cat_id']); ?>" method="post">
                            <!-- Modal body -->
                            <div class="modal-body">
                              <div class="form-group row">
                                <label for="input-10" class="col-sm-2 col-form-label">Name</label>
                                <div class="col-sm-8">
                                  <input type="text" class="form-control" id="input-10" name="Cat_name" value="<?php echo $row['Cat_name'] ?>">
                                </div>
                              </div>
                            </div>
                            <!-- Modal footer -->
