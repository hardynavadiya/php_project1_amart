...
<html lang="en">
  <head>
    ...
    <title>A-Mart Smart Shopping-Category</title>
    <!--favicon-->
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <hr>
                  <form action="php/add_cat.php" method="post" id="signupForm">
                    <div class="form-group">
                      <label for="input-6">Category Name</label>
                      <input type="text" name="Cat_name" class="form-control form-control-rounded" id="Cat_name" placeholder="Enter Category Name" >
                    </div>
                    <div class="form-group">
