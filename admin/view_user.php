...
<html lang="en">
  <head>
    ...
    <title>A-Mart Smart Shopping-View User</title>
    <!--favicon-->
    <!-- responsive -->
                    ...
                    <table id="example" class="table table-striped table-bordered dt-responsive nowrap display responsive">
                      ...
                      <tbody>
                        <?php
                          ...
                          <td><?php echo $value['U_mname'] ?></td>
                          <td><?php echo $value['U_lname'] ?></td>
                          <td><?php echo $value['U_email'] ?></td>
                          <td><?php echo $value['U_created'] ?></td>
                          <td><?php echo $value['U_updated'] ?></td>
                          <td style="padding: 0px;">
                            <?php if($value['U_status'] == 0) { ?>
                            <a href="php/changestatus_user?id=<?php echo $value['U_id']?>">
                            ...
                            <?php } ?></a>
                            <a href="php/user_delete?id=<?php echo $value['U_id'] ?>">
