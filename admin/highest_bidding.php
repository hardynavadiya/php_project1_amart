<?php
  ...
  include "php/highest_bidding.php";
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>A-Mart Smart Shopping-View Highest Bidding</title>
    <!--favicon-->
    <!-- responsive -->
      ...
      <div class="content-wrapper">
        <div class="container-fluid">
          ...
          <div class="row pt-2 pb-2">
            <div class="col-sm-9">
              <h4 class="page-title">View Highest Bidding</h4>
            </div>
          </div>
          <!-- End Breadcrumb-->
          <div class="row">
                        ...
                        <table id="example" class="table table-striped table-bordered dt-responsive nowrap display responsive">
                          <thead>
                            <tr>
                              <th>Id</th>
                               ...
                               <th>User Name</th>
                              <th>Product name</th>
                              <th>Product bidding End time</th>
                              <th>Price</th>
                              <th>Action</th>
                            </tr>
                          </thead>
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>₹<?php echo $value['Bidding'] ?></td>
                              <td>
                                <form method="post" action="php/check_bidding">
                                  <input type="hidden" name="P_id" value="<?php echo $value['P_id'] ?>">
                                  <input type="hidden" name="U_id" value="<?php echo $value['U_id'] ?>">
                                  <input type="hidden" name="S_price" value="<?php echo $value['P_price'] ?>">
