...
<head>
    ...
    <title>A-Mart Smart Shopping - forgot password</title>
                    ...
                    <div class="col-lg-12">
                        <div class="shop-head-menu">
                            <ul>
                                ...
                                <li class="shop-pro">Forgot Password</li>
                            </ul>
                        </div>
                    </div>
                    <!--end-shop-head-->
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="login-content banner-r-b">
                            <h2 class="price text-success">Forgot Password</h2>   
                            <form action="php/forgetpwd" method="post" id="signupForm">
                                <div>
